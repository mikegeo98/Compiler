...
Υποθέσεις:
  ...
  3. Η κατάληξη των προγραμμάτων στην αρχική σας γλώσσα είναι "alan"
     και ο μεταγλωττιστής σας λέγεται "alanc".  Αν όχι, τροποποιήστε
     τις μεταβλητές MYLANG και MYCOMP αντίστοιχα, στο πάνω μέρος των
     scripts.

  4. Στο αρχείο "alan.lib" (προκύπτει από τη μεταβλητή MYLIB στο
